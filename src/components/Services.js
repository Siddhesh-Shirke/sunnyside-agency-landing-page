...
export default function Services(){
    return(
        <section className="services">
            ...
            <ServiceImg 
            url="https://siddheshshirke.files.wordpress.com/2022/04/image-transform.jpg"/>

            <ServiceImg 
            url="https://siddheshshirke.files.wordpress.com/2022/04/image-stand-out.jpg"/>
            ...
            <ServiceDescImgFused 
            url="https://siddheshshirke.files.wordpress.com/2022/04/image-graphic-design.jpg"
            ...
            <ServiceDescImgFused 
            url="https://siddheshshirke.files.wordpress.com/2022/04/image-photography.jpg"
                                color="hsl(198, 62%, 26%)"
                                 heading="Photography"
